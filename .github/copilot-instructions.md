# GitHub Copilot Instructions & Custom Tools Rules

This file serves as the system rules configuration for GitHub Copilot. To separate AI instructions from project documentation, the full documentation is organized under the `docs/` directory.
...
To ensure these rules remain active inside Copilot, the core workspace rules are summarized below:

### 1. Project Architecture
- We are running a monorepo setup:
  - `apps/frontend` contains an Angular application.
  - `apps/backend` contains a NestJS application.
- Follow the feature organization guidelines in [docs/ai/CODING_GUIDELINES.md](../docs/ai/CODING_GUIDELINES.md).

### 2. Custom Tools Rules (Workspace `/tools`)
